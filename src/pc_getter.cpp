...
uint64_t PCGetter::stop_and_get_pc_offset() {
    ...
    AMDDBGAPI_CHECK(amd_dbgapi_wave_resume (waves[0], AMD_DBGAPI_RESUME_MODE_NORMAL));
...
void PCGetter::continue_wave() {
    amd_dbgapi_wave_resume (_last_wave_id, AMD_DBGAPI_RESUME_MODE_NORMAL); //0 means AMD_DBGAPI_RESUME_MODE_NORMAL
}